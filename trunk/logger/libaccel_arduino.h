 ...
 * Author: Mark R.
 * Date: 09.09.2010
 * Description: Uses the i2c bus to get acceleration measurements from the
 * ADXL345. The code for actually retrieving the measurement from the accelo 
 * was provided by Euristic at:
